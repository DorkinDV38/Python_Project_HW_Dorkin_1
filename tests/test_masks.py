...
@pytest.mark.parametrize(
    "value, expected",
    [("73654108430135874305", "**4305"), ("73654108430135874959", "**4959"), ("1234567890", "**7890")],
)
def test_get_mask_account(value: Union[str, int], expected: str) -> None:
...
def test_short_accounts(short_account: Union[str, int], error_message: str) -> None:
...
def test_get_mask_card_number(value: Union[str, int], expected: str) -> None:
...
def test_get_mask_card_number_invalid_inputs(input_card: Union[str, int], error_message: str) -> None:
