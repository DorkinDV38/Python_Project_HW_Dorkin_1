...
@pytest.fixture
def operations_data_no_status_f ():
    return [{'id': 41428829, 'state': 'CANCELED', 'date': '2019-07-03T18:35:29.512364'},
...
@pytest.fixture
def operations_data_sort_des_f ():
    return [{'id': 41428829, 'state': 'CANCELED', 'date': '2026-01-08T22:34:25.241689'},
...
@pytest.fixture
def operations_data_equal_date_f ():
    return [{'id': 41428829, 'state': 'EXECUTED', 'date': '2026-01-12T22:34:25.241689'},
